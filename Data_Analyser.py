...
input("This program relies on it being the format which HiSPARC has it in from their website.\nIf your data is not in that format, sorry, but this program won't work.\nIt'll probably tell you that at some point. Probably.\nPress enter to continue... ")
...
if Type=="d":
    ...
    while LineIndex<(len(Data)-1):
        ...
        #elif TimeToSeconds(Line.split("\t")[2])>=(TimeToSeconds(VST)+Blocks):
        else:
    ...
    if FileWanted=="y":
        ...
        while GraphWanted!="y" and GraphWanted!="n":
            GraphWanted=input("Do you want a graph for this? (y/n) : ").lower()
